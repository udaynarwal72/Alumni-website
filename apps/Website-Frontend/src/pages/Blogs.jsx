		...
		const fetchBlogData = async () => {
			try {
				...
				const userData = await axios.get(
					`http://localhost:3000/api/v1/user/getuserbyid/${blogResponse.data.data.blog_createdBy}`
				);
					...
					<div className="content">
						...
						<div className="header">
							<div className="profile">
								<div className="image">
									<img
										src="https://miro.medium.com/v2/resize:fill:55:55/1*7l1EOKCS6EEzIAmGbUWsxg.jpeg"
										alt="User profile"
									/>
								</div>
								<div className="info">
